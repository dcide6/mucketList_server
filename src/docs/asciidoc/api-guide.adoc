...
==== Request
include::{snippets}/join/http-request.adoc[leveloffset=+3]

==== Curl Request
include::{snippets}/join/curl-request.adoc[leveloffset=+3]

==== Response
include::{snippets}/join/http-response.adoc[leveloffset=+3]
