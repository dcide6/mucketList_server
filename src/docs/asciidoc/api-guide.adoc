...
==== Request
include::{snippets}/check-password/http-request.adoc[leveloffset=+3]

==== Curl Request
include::{snippets}/check-password/curl-request.adoc[leveloffset=+3]

==== Response
include::{snippets}/check-password/http-response.adoc[leveloffset=+3]
